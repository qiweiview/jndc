...
public class HttpResponseBuilder {
    ...
    public static FullHttpResponse textResponse() {
        return defaultResponse(new byte[0], TEXT_PLAIN);
    }
    ...
    public static FullHttpResponse defaultResponse(byte[] bytes, String contentType) {
        ...
        DefaultCookie nettyId = new DefaultCookie("n_id", UUID.randomUUID().toString());
        headers.set(HttpHeaderNames.SET_COOKIE, ServerCookieEncoder.STRICT.encode(nettyId));
        return defaultHttpResponse;
    }
