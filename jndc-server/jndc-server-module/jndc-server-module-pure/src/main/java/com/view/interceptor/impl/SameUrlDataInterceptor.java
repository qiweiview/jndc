package com.view.interceptor.impl;


import com.view.annotation.RepeatSubmit;
import com.view.constant.CacheConstants;
import com.view.filter.RepeatedlyRequestWrapper;
...
public class SameUrlDataInterceptor extends RepeatSubmitInterceptor
{
    ...
    public boolean isRepeatSubmit(HttpServletRequest request, RepeatSubmit annotation)
    {
        ...
        {
            nowParams = Jackson.toJson(request.getParameterMap());
        }
        ...
        Object sessionObj = redisCacheUtils.getCacheObject(cacheRepeatKey, Map.class);
        if (sessionObj != null)
        {
