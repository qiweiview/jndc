...
(
    id                 BIGINT NOT NULL,
    create_time        TIMESTAMP NULL DEFAULT NULL,    -- 将 datetime 改为 TIMESTAMP
    update_time        TIMESTAMP NULL DEFAULT NULL,    -- 同上
    client_name        VARCHAR(255) NULL DEFAULT NULL, -- 移除 CHARACTER SET 和 COLLATE
    client_remark      VARCHAR(255) NULL DEFAULT NULL, -- 同上
    client_status      VARCHAR(255) NULL DEFAULT NULL, -- 同上
    bind_server_host   VARCHAR(255) NULL DEFAULT NULL, -- 同上
    bind_server_port   INT NULL DEFAULT NULL,
    disguised_protocol VARCHAR(255) NULL DEFAULT NULL, -- 同上
    unique_id          VARCHAR(36) NULL DEFAULT NULL,  -- 同上
    PRIMARY KEY (id)                                   -- 直接指定主键，不需要 `USING BTREE`
);
