...
INSERT INTO `sys_menu`
VALUES (1867209707094114306, 'JNDCServer', '列表', 1867209453162561537, 1, '/server/list', 'jndc_server/index',
        NULL, 0, 1, 0, '', 'ep:brush-filled', 1, '2024-12-12 22:07:40', 1, '2024-12-12 22:15:38', '', 0, '', 0, '');


INSERT INTO `sys_menu`
VALUES (1867209707094114308, 'JNDCAccessHistory', '访问记录', 1867209453162561537, 4, '/server/jndc_access_history',
        'jndc_access_history/index',
        NULL, 0, 1, 0, '', 'fa-solid:eye', 1, '2024-12-12 22:07:40', 1, '2024-12-12 22:15:38', '', 0, '', 0, '');

INSERT INTO `sys_menu`
VALUES (1867209707094114309, 'JNDCServerApp', '服务应用', 1867209453162561537, 3, '/server/jndc_server_app',
