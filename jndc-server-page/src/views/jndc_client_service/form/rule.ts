...
export const formRules = reactive(<FormRules>{
  autoRegister: [{ required: true, message: "是否自动注册为必填", trigger: "blur" }],
  belongClientId: [{ required: true, message: "所属客户端id为必填", trigger: "blur" }],
  clientUniqueId: [{ required: true, message: "客户端唯一id为必填", trigger: "blur" }],
